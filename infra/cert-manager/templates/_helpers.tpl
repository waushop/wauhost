...
*/}}
{{- define "cert-manager.clusterIssuerName" -}}
{{- .Values.clusterIssuer.name | default "letsencrypt" }}
{{- end }}

{{/*
Create the name of the staging ClusterIssuer
*/}}
{{- define "cert-manager.stagingClusterIssuerName" -}}
{{- printf "%s-staging" (include "cert-manager.clusterIssuerName" .) }}
{{- end }}